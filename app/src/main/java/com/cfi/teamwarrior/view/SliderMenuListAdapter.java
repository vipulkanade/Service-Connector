...
public class SliderMenuListAdapter extends BaseAdapter {
    ...
    public static final int iSliderMenuItems[] = {R.string.post_job, R.string.previous_job};
...
//        oSliderMenuText.setTextColor(ContextCompat.getColor(mContext, R.color.green_color));
